...
{Type = SubSystem,
	...
	Description = "$7121"},
{Type = SubSystem,
	ThingToBuild = "Vgr_C_module_turret_2",
	RequiredResearch = "DestroyerGuns",
	RequiredFleetSubSystems = "",
	DisplayPriority = 28,
	DisplayedName = "Port Kinetic Turret",
	Description = "Gun"},
{Type = SubSystem,
	ThingToBuild = "Vgr_C_module_turret_1",
	RequiredResearch = "DestroyerGuns",
	RequiredFleetSubSystems = "",
	DisplayPriority = 29,
	DisplayedName = "Starboard Kinetic Turret",
	Description = "Gun"},
{Type = SubSystem,
	ThingToBuild = "Vgr_C_missileBattery",
	RequiredResearch = "DestroyerGuns",
	RequiredFleetSubSystems = "",
	DisplayPriority = 30,
	DisplayedName = "Quad Missile Battery",
